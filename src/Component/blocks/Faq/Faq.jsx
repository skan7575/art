        ...
        <section className={styles.section}>
            <div className={styles.container}>
                ...
                <details>
                    ...
                    <div className={styles.faq__content}>
                        <p className={styles.faq__text}>Срок изготовления картин:
                            <ul>
                                <li> в стилизаций “Standart” в среднем 1 — 2 рабочих дня.</li>
                                <li> в стилизаций “Premium” в среднем 7 — 8 рабочих дней.</li>
                            </ul>
                            ...
                            Перед отправкой хорошо упаковываем картины: пузырьковая пленка, стрейч, картон, когда нужно
                ...
                <details >
                    ...
                    <div className="faq__content">
                        <p className={styles.faq__text}>Провести оплату электронным способом на карту банка: Visa, MasterCard и «Мир»</p>
                    </div>
                </details>
            </div>
        </section>
